...
typedef std::vector<str_or_num> sn_vec;
/*
struct Dict {
...
void print_at(int index, std::string fmt, const sn_vec &v = {});
void print_at(int index, const char fmt[], const sn_vec &v = {});
void print_at(int index, bool shared, std::string fmt, const sn_vec &v = {});
